...
function CardHeader(props) {
  ...
  var mergedProps = _objectSpread(_objectSpread(_objectSpread({}, defaultProps), (0, _context.useCardContext)()), props);

  var isBorderless = mergedProps.isBorderless,
      size = mergedProps.size;
  var classes = (0, _classnames.default)('components-card__header', isBorderless && 'is-borderless', isShady && 'is-shady', size && "is-size-".concat(size), className);
