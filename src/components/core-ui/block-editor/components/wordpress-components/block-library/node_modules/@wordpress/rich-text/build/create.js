...
function createFromElement(_ref3) {
  ...
  var _loop = function _loop(index) {
    ...
    var format = (0, _isFormatEqual.isFormatEqual)(newFormat, lastFormat) ? lastFormat : newFormat;
    ...
    if (multilineWrapperTags && multilineWrapperTags.indexOf(type) !== -1) {
      var _value = createFromMultilineElement({
        ...
        multilineTag: multilineTag,
        multilineWrapperTags: multilineWrapperTags,
        currentWrapperTags: [].concat((0, _toConsumableArray2.default)(currentWrapperTags), [format]),
        isEditableTree: isEditableTree,
        preserveWhiteSpace: preserveWhiteSpace
      });
    ...
    if (!format) {
      ...
      function mergeFormats(formats) {
        ...
        var newFormats = formats ? [format].concat((0, _toConsumableArray2.default)(formats)) : [format];
      ...
      (0, _concat.mergePair)(accumulator, _objectSpread(_objectSpread({}, value), {}, {
