...
function segmentHTMLToShortcodeBlock(HTML) {
  ...
  if (match = (0, _shortcode.next)(transformTag, HTML, lastIndex)) {
    ...
    var block = (0, _factory.createBlock)(transformation.blockName, (0, _parser.getBlockAttributes)(_objectSpread(_objectSpread({}, (0, _registration.getBlockType)(transformation.blockName)), {}, {
