...
export var BottomSheetContext = createContext({
  ...
  shouldEnableBottomSheetMaxHeight: function shouldEnableBottomSheetMaxHeight() {},
  // Callback that is called on closing bottom sheet
  onHandleClosingBottomSheet: function onHandleClosingBottomSheet() {},
  ...
  onHandleHardwareButtonPress: function onHandleHardwareButtonPress() {}
});
var BottomSheetProvider = BottomSheetContext.Provider,
    BottomSheetConsumer = BottomSheetContext.Consumer;
