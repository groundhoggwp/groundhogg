...
function getColorAndStyleProps(attributes, colors) {
  ...
  if (isEdit) {
    if (backgroundColor) {
      var backgroundColorObject = (0, _blockEditor.getColorObjectByAttributeValues)(colors, backgroundColor);
      styleProp.backgroundColor = backgroundColorObject.color;
    }

    if (textColor) {
      var textColorObject = (0, _blockEditor.getColorObjectByAttributeValues)(colors, textColor);
