					...
					{(isDisabled) =>
						isPreview || isDisabled ? (
							...
							<PlainText
								...
								placeholder={__('This is some custom HTML which you can edit on the right. You may enter any valid HTML tags, but they may get filtered out as some email browsers to not support certain HTML.')}
								aria-label={__('HTML')}
							/>
						)
					}
