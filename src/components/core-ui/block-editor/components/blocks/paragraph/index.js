...
registerBlockType('groundhogg/paragraph', {
					...
					<PanelBody title={__('Font')}>
						<SelectControl
							...
							options={[
								...
								{value: 'Arial Black, Arial, sans-serif', label: __('Arial Black')},
								{value: 'Century Gothic, Times, serif', label: __('Century Gothic')},
								{value: 'Courier, monospace', label: __('Courier')},
								{value: 'Courier New, monospace', label: __('Courier New')},
								{value: 'Geneva, Tahoma, Verdana, sans-serif', label: __('Geneva')},
								{value: 'Georgia, Times, Times New Roman, serif', label: __('Georgia')},
								{value: 'Helvetica, Arial, sans-serif', label: __('Helvetica')},
								{value: 'Lucida, Geneva, Verdana, sans-serif', label: __('Lucida')},
								{value: 'Tahoma, Verdana, sans-serif', label: __('Tahoma')},
								{value: 'Times, Times New Roman, Baskerville, Georgia, serif', label: __('Times')},
								{value: 'Times New Roman, Times, Georgia, serif', label: __('Times New Roman')},
	...
	save: (props) => {
		...
		return <p style={style}><RichText.Content value={content}/></p>;
	},
});
