...
import { BlockNavigationDropdown } from "@wordpress/block-editor";
...
function HeaderPrimary() {
  const inserterButton = useRef(); // Consider adding to core actions

  /* const { setIsInserterOpened } = useDispatch( 'core/edit-post' ); */ const isInserterOpened = false;
