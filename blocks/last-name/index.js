...
export default registerBlockType(
    'groundhogg/last-name',
    {
        title: __( 'Last Name', 'groundhogg' ),
        ...
        attributes: {
            ...
            label: {
                ...
                source: 'children',
                selector: 'label',
                default: __( 'Last Name *' , 'groundhogg' )
            },
            required: {
                type: 'boolean',
                default: true,
                    ...
                    <p>
                        {
                            showLabel &&  <div className="gh-input-label-container">
                                <label htmlFor="gh-last-name" className="gh-input-label gh-last-name-label">{label}</label>
                            </div>
                        }
                        <div className="gh-input-container">
                            <input
                                ...
                                id="gh-last-name"
                                name="last_name"
                                className={ classnames( 'gh-input', 'gh-last-name', { 'required': required } ) }
                                placeholder={placeholder}
                                style={ {
                                    width: width + '%',
                                    fontSize: fontSize + 'px',
