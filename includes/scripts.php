...
class Scripts {
	...
	public function register_frontend_scripts() {
		...
		wp_register_script( 'groundhogg-ajax-form', GROUNDHOGG_ASSETS_URL . 'js/frontend/form' . $dot_min . '.js', [
			'groundhogg-frontend'
		...
		wp_localize_script( 'groundhogg-frontend', 'Groundhogg', [
...
//		wp_deregister_script( 'moment-js' );
	...
	public function register_admin_styles() {
		...
		wp_register_style( 'groundhogg-admin-contact-editor', GROUNDHOGG_ASSETS_URL . 'css/admin/contact-editor.css', [
			'groundhogg-admin',
			'groundhogg-admin-element',
