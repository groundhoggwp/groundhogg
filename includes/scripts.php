...
//			'groundhogg-tinymce-plugin'
	...
	public function register_admin_styles() {
		...
		wp_register_style( 'groundhogg-admin-search-filters', GROUNDHOGG_ASSETS_URL . 'css/admin/search-filters.css', [ 'groundhogg-admin', 'groundhogg-admin-element' ], GROUNDHOGG_VERSION );
