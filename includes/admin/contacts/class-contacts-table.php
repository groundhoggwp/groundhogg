...
class WPFN_Contacts_Table extends WP_List_Table {
	...
	protected function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			case 'email':
				$editUrl = admin_url( 'edit.php?post_type=infusion_form&page=formlift_contacts&edit_contact=' . $item['ID'] );
	...
	", ARRAY_A );
			...
			$data = $wpdb->get_results( "SELECT ID, email, first_name, last_name, time, inf_id FROM $table_name ORDER BY time DESC", ARRAY_A );
		}
