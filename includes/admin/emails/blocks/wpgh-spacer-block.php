...
class WPGH_Spacer_Block extends WPGH_Email_Block
{
    ...
    public function __construct()
    {
        ...
        wp_enqueue_script( 'wpgh-spacer-block', WPGH_ASSETS_FOLDER . 'js/admin/email-blocks/spacer.js', array(), filemtime( WPGH_PLUGIN_DIR . 'assets/js/admin/email-blocks/spacer.js' ) );
