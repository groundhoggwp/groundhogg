...
function wpgh_form_fill_funnel_step_html( $step_id )
{
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td><p><strong><input onfocus="this.select()" class="regular-text code" type="text" value='[gh_form id="<?php echo $step_id; ?>" fields="first,last,email,phone,terms" submit="submit" success="<?php echo esc_url( site_url( '/thank-you/' ) );?>" labels="off"]' readonly></strong></p>
            </td>
        </tr>
    </table>
