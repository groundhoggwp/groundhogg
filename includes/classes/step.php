...
class Step extends Base_Object_With_Meta implements Event_Process {
	...
	public function get_controls() {
		...
		if ( has_filter( "groundhogg/steps/{$this->get_type()}/controls" ) ) {
			$controls = apply_filters( "groundhogg/steps/{$this->get_type()}/controls", $this );
		}
	...
	public function get_as_array() {
		$array                   = parent::get_as_array(); // TODO: Change the autogenerated stub
		$array['delay']          = $this->get_delay_config();
		$array['icon']           = $this->icon();
		$array['settings']       = $this->get_all_meta();
		$array['controls']       = $this->get_controls();
