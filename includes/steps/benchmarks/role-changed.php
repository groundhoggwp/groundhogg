 ...
 * Role Changed
 *
 * This will run whenever a role is changed
 *
...
class Role_Changed extends Benchmark {
	...
	public function get_description() {
		return _x( 'Runs whenever a role is changed.', 'step_description', 'groundhogg' );
	}
	...
	protected function get_complete_hooks() {
		return [
			...
			'groundhogg/step/role/changed'        => 4
		];
	}
	...
	protected function can_complete_step() {
		...
		// False if the funnel ID is set (From Role step) and the current step is not in that funnel
