 ...
 * Logged In
 *
 * This will run whenever a user logs in
 *
 ...
 * @package     Elements
 */
class Logged_In extends Benchmark {

	public function get_help_article() {
		return 'https://docs.groundhogg.io/docs/builder/benchmarks/logged-in/';
	}
	...
	public function get_name() {
		return _x( 'Logged In', 'step_name', 'groundhogg' );
	}
	...
	public function get_icon() {
		return GROUNDHOGG_ASSETS_URL . '/images/funnel-icons/logged-in.png';
	}
	 ...
	 * @param $funnel_id      int|bool only passed in SendEMail step if skip if in is enabled.
	 */
	...
	protected function can_complete_step() {
		...
		// False if the funnel ID is set (From Logged step) and the current step is not in that funnel
