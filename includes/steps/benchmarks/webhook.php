 ...
 * Webhook
 *
 * This will run when a webhook is called
 *
 ...
 * @package     Elements
 */
class Webhook extends Benchmark {

	public function get_help_article() {
		return 'https://docs.groundhogg.io/docs/builder/benchmarks/webhook/';
	}
	...
	public function get_description() {
		return _x( 'Runs when a webhook is called.', 'step_description', 'groundhogg' );
	}
	...
	public function get_icon() {
		return GROUNDHOGG_ASSETS_URL . '/images/funnel-icons/webhook.png';
	}
