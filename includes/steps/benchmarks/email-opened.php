 ...
 * Email Opened
 *
 * This will run whenever an email is opened
 *
...
class Email_Opened extends Benchmark {
	...
	public function get_help_article() {
		return 'https://docs.groundhogg.io/docs/builder/benchmarks/email-opened/';
	}
	...
	public function get_name() {
		return _x( 'Email Opened', 'step_name', 'groundhogg' );
	}
	...
	public function get_icon() {
		return GROUNDHOGG_ASSETS_URL . '/images/funnel-icons/email-opened.png';
	}
	...
	protected function get_complete_hooks() {
		return [
			...
			'groundhogg/step/email/opened'        => 4
		];
	}
	 ...
	 * @param $funnel_id      int|bool only passed in SendEMail step if skip if opened is enabled.
	 */
