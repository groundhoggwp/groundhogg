 ...
 * Field Changed
 *
 * This will run whenever an field is changed
 *
...
class Field_Changed extends Benchmark {
	...
	public function get_help_article() {
		return 'https://docs.groundhogg.io/docs/builder/benchmarks/field-changed/';
	}
	...
	public function get_description() {
		return _x( 'Runs whenever a field is changed.', 'step_description', 'groundhogg' );
	}
	...
	protected function get_complete_hooks() {
		return [
			...
			'groundhogg/step/field/changed'        => 4
		];
	}
	 ...
	 * @param $funnel_id      int|bool only passed in SendEMail step if skip if changed is enabled.
	 */
	...
	protected function can_complete_step() {
		...
		// False if the funnel ID is set (From Field step) and the current step is not in that funnel
