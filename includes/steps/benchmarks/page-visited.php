...
class Page_Visited extends Benchmark {
	...
	public function get_description() {
		return _x( 'Runs whenever a page is visited.', 'step_description', 'groundhogg' );
	}
	...
	protected function get_complete_hooks() {
		return [
			...
			'groundhogg/step/page/visited'        => 4
		];
	}
	 ...
	 * @param $funnel_id      int|bool only passed in SendEMail step if skip if visited is enabled.
	 */
	...
	protected function can_complete_step() {
		...
		// False if the funnel ID is set (From Page step) and the current step is not in that funnel
