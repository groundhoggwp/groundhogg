 ...
 * Plugin API
 *
 * This will run whenever the plugin api is called
 *
...
class Plugin_API extends Benchmark {
	...
	public function get_help_article() {
		return 'https://docs.groundhogg.io/docs/builder/benchmarks/plugin-api/';
	}
	...
	public function get_name() {
		return _x( 'Plugin API', 'step_name', 'groundhogg' );
	}
	...
	public function get_description() {
		return _x( 'Runs whenever the plugin api is called.', 'step_description', 'groundhogg' );
	}
	 ...
	 * @param $funnel_id      int|bool only passed in SendEMail step if skip if api is enabled.
	 */
	...
	protected function can_complete_step() {
		...
		// False if the funnel ID is set (From Plugin step) and the current step is not in that funnel
