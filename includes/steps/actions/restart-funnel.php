 ...
 */
class Restart_Funnel extends Action {
	...
	public function get_name() {
		return _x( 'Restart Funnel', 'step_name', 'groundhogg' );
	}
	...
	public function get_description() {
		return _x( 'Restart a funnel from a specific point.', 'step_description', 'groundhogg' );
	}
	...
	public function save( $step ) {
		...
		$this->save_setting( 'method', $this->get_posted_data( 'method', 'beginning' ) );
