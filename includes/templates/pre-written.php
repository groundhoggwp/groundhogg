...
$pre_written_emails['cta']['title'] = __( "Call To Action", 'wp-funnels' );
$pre_written_emails['cta']['description'] = __( "Use when you need contacts to take an action, and FAST!", 'wp-funnels' );
$pre_written_emails['cta']['content'] = ob_get_contents();
...
$pre_written_emails['plain']['title'] = __( "Plain Text", 'wp-funnels' );
$pre_written_emails['plain']['description'] = __( "Perfect for easy breezy communication with contacts.", 'wp-funnels' );
$pre_written_emails['plain']['content'] = ob_get_contents();
...
$pre_written_emails['hype']['title'] = __( "Hype Up", 'wp-funnels' );
$pre_written_emails['hype']['description'] = __( "Need people excited? This is what you need!", 'wp-funnels' );
$pre_written_emails['hype']['content'] = ob_get_contents();
...
$pre_written_emails['welcome']['title'] = __( "Welcome Email", 'wp-funnels' );
$pre_written_emails['welcome']['description'] = __( "New contact? Make the feel at home.", 'wp-funnels' );
$pre_written_emails['welcome']['content'] = ob_get_contents();
...
$pre_written_emails['review']['title'] = __( "Review Request", 'wp-funnels' );
$pre_written_emails['review']['description'] = __( "Want feedback? This is the easiest way to get it.", 'wp-funnels' );
$pre_written_emails['review']['content'] = ob_get_contents();
...
$pre_written_emails['value']['title'] = __( "You're Awesome", 'wp-funnels' );
$pre_written_emails['value']['description'] = __( "Want feedback? This is the easiest way to get it.", 'wp-funnels' );
$pre_written_emails['value']['content'] = ob_get_contents();
