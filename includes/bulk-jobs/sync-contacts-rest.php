...
class Sync_Contacts_Rest extends Bulk_Job {
...
//		return min( 100, intval( ini_get( 'max_input_vars' ) ) );
	...
	protected function process_item( $item ) {
		...
		create_contact_from_user( absint( $item ), $this->get_context( 'sync_meta' ) );
	}
