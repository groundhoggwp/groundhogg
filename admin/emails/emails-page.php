...
class Emails_Page extends Admin_Page
{
    ...
    protected function get_current_action() {
	    $action = parent::get_current_action(); // TODO: Change the autogenerated stub

        // use plain email editor if option is enabled.
//        if ( $action === 'edit' && Groundhogg\is_option_enabled( 'gh_use_plain_email_editor' ) ){
//            return 'edit_plain';
//        }
...
//
//        if (Groundhogg\is_sms_plugin_active()) {
//            return 'edit';
//        }
	...
	/**
	 * @return array|bool|Email|\WP_Error
	 */
    public function process_edit_plain()
    {
        $email = $this->process_edit();

        if ( ! is_wp_error( $email ) ){
            $email->update_meta( 'is_plain', true );
            return true;
        }
