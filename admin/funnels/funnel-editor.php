    ...
    <div class="header-wrap">
        ...
        <div class="funnel-editor-header sub-header">
            ...
            <div class="toolbar-buttons">
                ...
                <a href="<?php echo esc_url( $funnel->export_url() ); ?>" class="gh-button secondary text icon"><span
        ...
        <div id="post-body">
            <div id="postbox-container-1" class="sidebar">
                <div class="fixed-inside">
                    <div id="step-sortable" class="ui-sortable"><?php foreach ( $funnel->get_steps() as $step ): ?><?php $step->sortable_item(); ?><?php endforeach; ?></div>
