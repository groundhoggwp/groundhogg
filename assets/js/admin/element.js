(function ($) {
  ...
  const icons = {
    // language=html
    mobile: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
	    <path fill="currentColor" d="M298.7 25.6h-85.4a8.5 8.5 0 000 17h85.4a8.5 8.5 0 000-17zM358.4 25.6h-8.5a8.5 8.5 0 000 17h8.5a8.5 8.5 0 000-17zM266.6 435.2h-21.2c-13 0-23.5 10.6-23.5 23.5v4.2c0 13 10.5 23.5 23.5 23.5h21.2c13 0 23.5-10.6 23.5-23.5v-4.2c0-13-10.5-23.5-23.5-23.5zm6.5 27.7c0 3.5-3 6.4-6.5 6.4h-21.2a6.5 6.5 0 01-6.5-6.4v-4.2c0-3.5 3-6.4 6.5-6.4h21.2c3.6 0 6.5 2.9 6.5 6.4v4.2z"/>
	    <path fill="currentColor" d="M370.2 0H141.8c-17 0-30.9 13.8-30.9 30.8v450.4c0 17 13.9 30.8 30.9 30.8h228.4c17 0 30.9-13.8 30.9-30.8V30.8c0-17-13.9-30.8-30.9-30.8zM384 481.2c0 7.5-6.2 13.7-13.8 13.7H141.8c-7.6 0-13.8-6.2-13.8-13.7V30.8c0-7.5 6.2-13.7 13.8-13.7h228.4c7.6 0 13.8 6.2 13.8 13.7v450.4z"/>
	    <path fill="currentColor" d="M392.5 51.2h-273a8.5 8.5 0 00-8.6 8.5v358.4c0 4.7 3.9 8.6 8.6 8.6h273c4.7 0 8.6-3.9 8.6-8.6V59.7c0-4.7-3.9-8.5-8.6-8.5zM384 409.6H128V68.3h256v341.3z"/>
    </svg>`,// language=html
    phone: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 473.8 473.8">
    ...
    // language=html
    contact: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
	    <path fill="currentColor"
