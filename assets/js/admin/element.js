( function ($) {
  ...
  const breadcrumbs = (parts) => {
    return parts.map(
      (p, i) => i < parts.length - 1 ? `<span class="part">${ p }</span>` : `<span class="base">${ p }</span>`).
  ...
  function orList (array) {
    ...
    return sprintf(_x('%s or %s', 'or preceding the last item in a list', 'groundhogg'), array.slice(0, -1).join(', '),
  ...
  const Elements = {
    ...
    textarea (props) {
      return `<textarea ${ objectToProps(Object.filter(props, key => key !== 'value')) }>${ specialChars(
    ...
    renderSearchOptions () {
      ...
      const optionDiv = (option, group, id, index) => {
        return `<div class="option ${ index === this.focusedOptionId
          ? 'focused'
          : '' }" data-option="${ id }" data-group="${ group }">${ renderOption(option) }</div>`
      }
  ...
  <path fill="currentColor"
    ...
    hollerbox: `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="75.3 55.7 580.9 152.3">
            ...
            <path fill="#e8ad0b" d="m190 101.9-45.6-26.3-45.6 26.3 45.6 26.3 45.5-26.3z"/>
            <path d="m126.5 170 18 10.4v-7.2l-18-10.4v7.2zm18-11.3-18-10.4v7.3l18 10.4v-7.3z"/>
            <path d="m190 101.9-45.6 26.3-45.6-26.3-8.6-5 56.5-32.6 43 25.4 7.4-4.3-50.3-29.7L75.3 97 95 108.4l49.3 28.4 49.3-28.4 8.5-5V166l-57.8 33.4-35.8-20.6-10.6 8.6v-14.7l-14-8.1v-48.9l-7.5-4.3v57.5l14 8.1v26.2l18.9-15.3 35 20.2 65.3-37.8V90.5l-19.8 11.4z"/>
        </svg>`,
