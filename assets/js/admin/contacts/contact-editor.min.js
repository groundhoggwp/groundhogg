            ...
            <li class="activity-item">
                ...
                <div class="activity-rendered gh-panel">
                    <div class="activity-info">
                        ...
                        ${ActivityDetails(activity.meta,{key:k=>`<code>${k}</code>`,heading:__("Request")})}
                    </div>
                    <div class="diff-time">
                        ${activity.i18n.diff_time}
                    </div>
