(function(Funnel,$){const{tags:TagsStore,emails:EmailsStore,funnels:FunnelsStore,campaigns:CampaignsStore}=Groundhogg.stores;const{get:apiGet,post:apiPost,delete:apiDelete,patch:apiPatch,routes:routes}=Groundhogg.api;const{v4:apiRoutes}=routes;const{improveTinyMCE:improveTinyMCE,dialog:dialog,confirmationModal:confirmationModal,dangerConfirmationModal:dangerConfirmationModal,loadingModal:loadingModal,modal:modal,select:select,input:input,textarea:textarea,objectEquals:objectEquals,copyObject:copyObject,uniqid:uniqid,specialChars:specialChars,regexp:regexp,tooltip:tooltip,toggle:toggle,savingModal:savingModal,moreMenu:moreMenu,clickInsideElement:clickInsideElement}=Groundhogg.element;const{campaignPicker:campaignPicker}=Groundhogg.pickers;const{StepTypes:StepTypes,StepPacks:StepPacks}=Groundhogg;const{__:__,_x:_x,_n:_n,_nx:_nx}=wp.i18n;const toEditorButton=()=>{return`
		<button id="close-email-editor" class="gh-button secondary text icon">
			...
			<div class="step-add">
				<div class="step-add-filters">
					...
					${input({id:"search-steps",name:"search_steps",type:"search",className:"search-steps",placeholder:_x("Search...","funnel editor","groundhogg"),value:search})}
