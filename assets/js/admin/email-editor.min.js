(function($){const{copyObject:copyObject,select:select,input:input,tinymceElement:tinymceElement,specialChars:specialChars,improveTinyMCE:improveTinyMCE,inputWithReplacementsAndEmojis:inputWithReplacementsAndEmojis,inputWithReplacements:inputWithReplacements,inputRepeaterWidget:inputRepeaterWidget,textarea:textarea,isValidEmail:isValidEmail,modal:modal,loadingDots:loadingDots,savingModal:savingModal}=Groundhogg.element;const{post:post,get:get,patch:patch,routes:routes}=Groundhogg.api;const{user_test_email:user_test_email}=Groundhogg;const EmailEditor=({selector:selector,email:email,onChange:onChange=email=>{},onCommit:onCommit=email=>{}})=>({selector:selector,email:copyObject(email),origEmail:copyObject(email),$el:$(selector),undoStates:[],redoStates:[],edited:{data:{},meta:{}},components:{editor:function(){return`
        ...
        `},content:function(){const{subject:subject="",pre_header:pre_header="",content:content=""}=this.edited.data;return`
			...
			<div class="inline-label">
				...
				${inputWithReplacementsAndEmojis({id:"preview-text",name:"pre_header",value:pre_header})}
			</div>
			<div class="email-content-wrap">
				${textarea({id:"content",name:"content",value:content})}
			</div>
        `},sidebar:function(){const message_typeOptions={marketing:"Marketing",transactional:"Transactional"};const{reply_to_override:reply_to_override="",alignment:alignment="left",from_user:from_user=0,message_type:message_type="marketing"}=this.edited.meta;return`
			<div class="gh-panel">
				<div class="inside">
