(function($){const{input,select,orList,andList,bold}=Groundhogg.element;const{broadcastPicker,funnelPicker,tagPicker,emailPicker,linkPicker,metaValuePicker,metaPicker,userMetaPicker}=Groundhogg.pickers;const{broadcasts:BroadcastsStore,emails:EmailsStore,tags:TagsStore,funnels:FunnelsStore,searches:SearchesStore}=Groundhogg.stores;const{sprintf,__,_x,_n}=wp.i18n;const{formatDate,formatDateTime}=Groundhogg.formatting;const{Fragment,ItemPicker,Select,Input,Div}=MakeEl;const{Filters,FilterRegistry,createFilter,createGroup}=Groundhogg.filters;const ContactFilterRegistry=FilterRegistry({});const uid=function(){return Date.now().toString(36)+Math.random().toString(36).substring(2)};const createFilters=(el="",filters=[],onChange=f=>{console.log(f)})=>({el:el,onChange:onChange,filters:Array.isArray(filters)?filters:[],id:uid(),init(){this.mount()},mount(){let container=document.querySelector(el);container.innerHTML="";document.querySelector(el).appendChild(Filters({id:this.id,filterRegistry:ContactFilterRegistry,filters:this.filters,onChange:this.onChange}))}});const registerFilterGroup=(group,name)=>{ContactFilterRegistry.registerGroup(createGroup(group,name))};const registerFilter=(type,group="general",name="",opts={})=>{if(typeof name==="object"){let tempOpts=name;name=tempOpts.name;opts=tempOpts}const{defaults:defaults={},preload:preload=()=>{},view:view=()=>"",edit:edit=()=>"",onMount:onMount=()=>""}=opts;ContactFilterRegistry.registerFilter(createFilter(type,name,group,{display:view,preload:preload,edit:({updateFilter,...filter})=>Fragment([edit(filter)],{onCreate:el=>{setTimeout(()=>{onMount(filter,updateFilter)},50)}})},defaults))};const AllComparisons={equals:_x("Equals","comparison","groundhogg"),not_equals:_x("Not equals","comparison","groundhogg"),contains:_x("Contains","comparison","groundhogg"),not_contains:_x("Does not contain","comparison","groundhogg"),starts_with:_x("Starts with","comparison","groundhogg"),ends_with:_x("Ends with","comparison","groundhogg"),does_not_start_with:_x("Does not start with","comparison","groundhogg"),does_not_end_with:_x("Does not end with","comparison","groundhogg"),less_than:_x("Less than","comparison","groundhogg"),less_than_or_equal_to:_x("Less than or equal to","comparison","groundhogg"),greater_than:_x("Greater than","comparison","groundhogg"),greater_than_or_equal_to:_x("Greater than or equal to","comparison","groundhogg"),empty:_x("Is empty","comparison","groundhogg"),not_empty:_x("Is not empty","comparison","groundhogg")};const StringComparisons={equals:_x("Equals","comparison","groundhogg"),not_equals:_x("Not equals","comparison","groundhogg"),contains:_x("Contains","comparison","groundhogg"),not_contains:_x("Does not contain","comparison","groundhogg"),starts_with:_x("Starts with","comparison","groundhogg"),ends_with:_x("Ends with","comparison","groundhogg"),does_not_start_with:_x("Does not start with","comparison","groundhogg"),does_not_end_with:_x("Does not end with","comparison","groundhogg"),empty:_x("Is empty","comparison","groundhogg"),not_empty:_x("Is not empty","comparison","groundhogg")};const NumericComparisons={equals:_x("Equals","comparison","groundhogg"),not_equals:_x("Not equals","comparison","groundhogg"),less_than:_x("Less than","comparison","groundhogg"),less_than_or_equal_to:_x("Less than or equal to","comparison","groundhogg"),greater_than:_x("Greater than","comparison","groundhogg"),greater_than_or_equal_to:_x("Greater than or equal to","comparison","groundhogg")};const ComparisonsTitleGenerators={equals:(k,v)=>sprintf(_x("%1$s equals %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),not_equals:(k,v)=>sprintf(_x("%1$s does not equal %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),contains:(k,v)=>sprintf(_x("%1$s contains %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),not_contains:(k,v)=>sprintf(_x("%1$s does not contain %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),starts_with:(k,v)=>sprintf(_x("%1$s starts with %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),ends_with:(k,v)=>sprintf(_x("%1$s ends with %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),does_not_start_with:(k,v)=>sprintf(_x("%1$s does not start with %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),does_not_end_with:(k,v)=>sprintf(_x("%1$s does not end with %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),less_than:(k,v)=>sprintf(_x("%1$s is less than %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),less_than_or_equal_to:(k,v)=>sprintf(_x("%1$s is less than or equal to %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),greater_than:(k,v)=>sprintf(_x("%1$s is greater than %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),greater_than_or_equal_to:(k,v)=>sprintf(_x("%1$s is greater than or equal to %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),in:(k,v)=>sprintf(_x("%1$s is %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),not_in:(k,v)=>sprintf(_x("%1$s is not %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),empty:(k,v)=>sprintf(_x("%1$s is empty","%1 is a key and %2 is user defined value","groundhogg"),k,v),not_empty:(k,v)=>sprintf(_x("%1$s is not empty","%1 is a key and %2 is user defined value","groundhogg"),k,v),includes:(k,v)=>sprintf(_x("%1$s includes %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v),excludes:(k,v)=>sprintf(_x("%1$s excludes %2$s","%1 is a key and %2 is user defined value","groundhogg"),k,v)};const pastDateRanges={any:__("At any time","groundhogg"),today:__("Today","groundhogg"),this_week:__("This week","groundhogg"),this_month:__("This month","groundhogg"),this_year:__("This year","groundhogg"),"24_hours":__("In the last 24 hours","groundhogg"),"7_days":__("In the last 7 days","groundhogg"),"30_days":__("In the last 30 days","groundhogg"),"60_days":__("In the last 60 days","groundhogg"),"90_days":__("In the last 90 days","groundhogg"),"365_days":__("In the last 365 days","groundhogg"),before:__("Before","groundhogg"),after:__("After","groundhogg"),between:__("Between","groundhogg")};const futureDateRanges={any:__("At any time","groundhogg"),today:__("Today","groundhogg"),this_week:__("This week","groundhogg"),this_month:__("This month","groundhogg"),this_year:__("This year","groundhogg"),"24_hours":__("In the next 24 hours","groundhogg"),"7_days":__("In the next 7 days","groundhogg"),"30_days":__("In the next 30 days","groundhogg"),"60_days":__("In the next 60 days","groundhogg"),"90_days":__("In the next 90 days","groundhogg"),"365_days":__("In the next 365 days","groundhogg"),before:__("Before","groundhogg"),after:__("After","groundhogg"),between:__("Between","groundhogg")};const standardActivityDateFilterOnMount=(filter,updateFilter)=>{$("#filter-date-range, #filter-before, #filter-after").on("change",function(e){const $el=$(this);updateFilter({[$el.prop("name")]:$el.val()});if($el.prop("name")==="date_range"){const $before=$("#filter-before");const $after=$("#filter-after");switch($el.val()){case"between":$before.removeClass("hidden");$after.removeClass("hidden");break;case"after":$after.removeClass("hidden");$before.addClass("hidden");break;case"before":$before.removeClass("hidden");$after.addClass("hidden");break;default:$before.addClass("hidden");$after.addClass("hidden");break}}})};const standardActivityDateTitle=(prepend,{date_range,before,after,future:future=false})=>{let ranges=future?futureDateRanges:pastDateRanges;switch(date_range){default:return`${prepend} ${ranges[date_range]?ranges[date_range].toLowerCase():""}`;case"between":return`${prepend} ${sprintf(_x("between %1$s and %2$s","where %1 and %2 are dates","groundhogg"),`<b>${formatDate(after)}</b>`,`<b>${formatDate(before)}</b>`)}`;case"before":return`${prepend} ${sprintf(_x("before %s","%s is a date","groundhogg"),`<b>${formatDate(before)}</b>`)}`;case"after":return`${prepend} ${sprintf(_x("after %s","%s is a date","groundhogg"),`<b>${formatDate(after)}</b>`)}`}};const standardActivityDateOptions=({date_range:date_range="24_hours",after:after="",before:before="",future:future=false})=>{return` ${select({id:"filter-date-range",name:"date_range"},future?futureDateRanges:pastDateRanges,date_range)}
      ...
      ${standardActivityDateOptions({date_range:date_range,before:before,after:after})}`},onMount(filter,updateFilter){funnelPicker("#filter-funnel",false,items=>{FunnelsStore.itemsFetched(items)},{},{placeholder:__("Select a funnel","groundhogg")}).on("select2:select",({target})=>{updateFilter({funnel_id:parseInt($(target).val()),step_id:0},true)});$("#filter-step").select2({placeholder:__("Select a step or leave empty for any step","groundhogg")}).on("select2:select",({target})=>{updateFilter({step_id:parseInt($(target).val())})});standardActivityDateFilterOnMount(filter,updateFilter)},defaults:{funnel_id:0,step_id:0,status:"complete",...standardActivityDateDefaults},preload:({funnel_id})=>{if(funnel_id){return FunnelsStore.maybeFetchItem(funnel_id)}}});registerFilterGroup("broadcast",_x("Broadcast","noun meaning email blast","groundhogg"));registerFilter("broadcast_received","broadcast",__("Received Broadcast","groundhogg"),{view({broadcast_id,status:status="complete"}){if(!broadcast_id){return __("Received any broadcast","groundhogg")}const broadcast=BroadcastsStore.get(broadcast_id);return status==="complete"?sprintf(broadcast?__("Received %1$s on %2$s","groundhogg"):__("Will receive a broadcast","groundhogg"),`<b>${broadcast.object.data.title}</b>`,`<b>${formatDateTime(broadcast.data.send_time*1e3)}</b>`):sprintf(broadcast?__("Will receive %1$s on %2$s","groundhogg"):__("Received a broadcast","groundhogg"),`<b>${broadcast.object.data.title}</b>`,`<b>${formatDateTime(broadcast.data.send_time*1e3)}</b>`)},edit({broadcast_id}){return select({id:"filter-broadcast",name:"broadcast_id"},BroadcastsStore.getItems().map(b=>({value:b.ID,text:`${b.object.data.title} (${b.date_sent_pretty})`})),broadcast_id)},onMount(filter,updateFilter){broadcastPicker("#filter-broadcast",false,items=>{BroadcastsStore.itemsFetched(items)},{},{placeholder:__("Select a broadcast","groundhogg")}).on("select2:select",({target})=>{updateFilter({broadcast_id:parseInt($(target).val())})})},defaults:{broadcast_id:0,status:"complete"},preload:({broadcast_id})=>{if(broadcast_id){return BroadcastsStore.maybeFetchItem(broadcast_id)}}});registerFilter("broadcast_opened","broadcast",__("Opened Broadcast","groundhogg"),{view({broadcast_id}){if(!broadcast_id){return __("Opened any broadcast","groundhogg")}const broadcast=BroadcastsStore.get(broadcast_id);return sprintf(broadcast?__("Opened %1$s after %2$s","groundhogg"):__("Will receive a broadcast","groundhogg"),`<b>${broadcast.object.data.title}</b>`,`<b>${formatDateTime(broadcast.data.send_time*1e3)}</b>`)},edit({broadcast_id}){return select({id:"filter-broadcast",name:"broadcast_id"},BroadcastsStore.getItems().map(b=>({value:b.ID,text:`${b.object.data.title} (${b.date_sent_pretty})`})),broadcast_id)},onMount(filter,updateFilter){broadcastPicker("#filter-broadcast",false,items=>{BroadcastsStore.itemsFetched(items)},{},{placeholder:__("Select a broadcast","groundhogg")}).on("select2:select",({target})=>{updateFilter({broadcast_id:parseInt($(target).val())})})},defaults:{broadcast_id:0},preload:({broadcast_id})=>{if(broadcast_id){return BroadcastsStore.maybeFetchItem(broadcast_id)}}});registerFilter("broadcast_link_clicked","broadcast",__("Broadcast Link Clicked","groundhogg"),{view({broadcast_id,link}){if(!broadcast_id&&!link){return __("Clicked any link in any broadcast","groundhogg")}if(!broadcast_id&&link){return sprintf(__("Clicked %s in any broadcast","groundhogg"),bold(link))}const broadcast=BroadcastsStore.get(broadcast_id);if(broadcast_id&&!link){return sprintf(__("Clicked any link in %1$s after %2$s","groundhogg"),bold(broadcast.object.data.title),bold(formatDateTime(broadcast.data.send_time*1e3)))}return sprintf(__("Clicked %1$s in %2$s after %3$s","groundhogg"),bold(link),bold(broadcast.object.data.title),bold(formatDateTime(broadcast.data.send_time*1e3)))},edit({broadcast_id,link}){return`
            ...
            ${input({id:"filter-link",name:"link",value:link,autocomplete:"off",placeholder:__("Start typing to select a link or leave blank for any link","groundhogg")})}`},onMount(filter,updateFilter){broadcastPicker("#filter-broadcast",false,items=>{BroadcastsStore.itemsFetched(items)},{},{placeholder:__("Please select a broadcast or leave blank for any broadcast","groundhogg")}).on("change",e=>{updateFilter({broadcast_id:parseInt(e.target.value)})});linkPicker("#filter-link").on("change input blur",({target})=>{updateFilter({link:target.value})})},defaults:{link:"",broadcast_id:0},preload:({broadcast_id})=>{if(broadcast_id){return BroadcastsStore.maybeFetchItem(broadcast_id)}}});const{tabs,fields,groups}=Groundhogg.filters.gh_contact_custom_properties;const getField=id=>{return fields.find(f=>f.id==id)};const{createDateFilter,createStringFilter,createNumberFilter,createTimeFilter}=Groundhogg.filters;const OptionsPicker=({field,options,updateFilter})=>ItemPicker({id:"filter-options",noneSelected:"Type to search...",selected:options.map(opt=>({id:opt,text:opt})),fetchOptions:async search=>field.options.filter(opt=>opt.match(new RegExp(search,"i"))).map(opt=>({id:opt,text:opt})),onChange:items=>updateFilter({options:items.map(item=>item.id)})});const filterFactory={text:({id,label,group})=>createStringFilter(id,label,group),url:({id,label,group})=>createStringFilter(id,label,group),custom_email:({id,label,group})=>createStringFilter(id,label,group),tel:({id,label,group})=>createStringFilter(id,label,group),textarea:({id,label,group})=>createStringFilter(id,label,group),number:({id,label,group})=>createNumberFilter(id,label,group),date:({id,label,group})=>createDateFilter(id,label,group),datetime:({id,label,group})=>createDateFilter(id,label,group),time:({id,label,group})=>createTimeFilter(id,label,group),radio:({id,label,group,...field})=>createFilter(id,label,group,{edit:({options,compare,updateFilter})=>Fragment([Select({id:"filter-compare",selected:compare,options:{in:_x("Is one of","comparison, groundhogg"),not_in:_x("Is not one of","comparison","groundhogg")},onChange:e=>updateFilter({compare:e.target.value})}),OptionsPicker({field:field,options:options,updateFilter:updateFilter})]),display:({options,compare})=>ComparisonsTitleGenerators[compare](bold(label),orList(options.map(o=>bold(o))))},{compare:"in",options:[]}),dropdown:({id,label,group,...field})=>createFilter(id,label,group,{edit:({options,compare,updateFilter})=>Fragment([Select({id:"filter-compare",selected:compare,options:field.multiple?{all_in:__("Has all selected"),all_not_in:__("Does not have all selected")}:{in:_x("Is one of","comparison, groundhogg"),not_in:_x("Is not one of","comparison","groundhogg")},onChange:e=>updateFilter({compare:e.target.value})}),OptionsPicker({field:field,options:options,updateFilter:updateFilter})]),display:({options,compare})=>{if(ComparisonsTitleGenerators[compare]){return ComparisonsTitleGenerators[compare](bold(label),orList(options.map(o=>bold(o))))}return moreComparisonTitles[compare](bold(label),options)}},{compare:field.multiple?"all_in":"in",options:[]}),checkboxes:({id,label,group,...field})=>createFilter(id,label,group,{edit:({options,compare,updateFilter})=>Fragment([Select({id:"filter-compare",selected:compare,options:{all_checked:__("Is Checked","groundhogg-better-meta"),not_checked:__("Is Not Checked","groundhogg-better-meta")},onChange:e=>updateFilter({compare:e.target.value})}),OptionsPicker({field:field,options:options,updateFilter:updateFilter})]),display:({options:options=[],compare:compare=""})=>moreComparisonTitles[compare](bold(label),options)},{compare:"all_checked",options:[]})};const moreComparisonTitles={all_checked:(prefix,options)=>sprintf(__("%2$s is checked for %1$s","groundhogg-better-meta"),prefix,andList(options.map(b=>bold(b)))),not_checked:(prefix,options)=>sprintf(__("%2$s is not checked for %1$s","groundhogg-better-meta"),prefix,andList(options.map(b=>bold(b)))),all_in:(prefix,options)=>sprintf(__("%2$s is selected for %1$s","groundhogg-better-meta"),prefix,andList(options.map(b=>bold(b)))),all_not_in:(prefix,options)=>sprintf(__("%2$s is not selected for %1$s","groundhogg-better-meta"),prefix,andList(options.map(b=>bold(b))))};Object.values(tabs).forEach(t=>{Object.values(groups).filter(f=>f.tab===t.id).forEach(s=>{let groupId=`${t.id}-${s.id}`;registerFilterGroup(groupId,`${t.name}: ${s.name}`);Object.values(fields).filter(f=>f.group===s.id).forEach(f=>{if(f.type in filterFactory){ContactFilterRegistry.registerFilter(filterFactory[f.type]({...f,group:groupId}))}})})});const registerActivityFilter=(id,group,label,{view:view=()=>{},edit:edit=()=>{},onMount:onMount=()=>{},defaults:defaults={}})=>{registerFilter(id,group,label,{view(filter){return standardActivityDateTitle(filterCountTitle(view(filter),filter),filter)},edit(filter){return[edit(filter),filterCount(filter),standardActivityDateOptions(filter)].join("")},onMount(filter,updateFilter){onMount(filter,updateFilter);filterCountOnMount(updateFilter);standardActivityDateFilterOnMount(filter,updateFilter)},defaults:{...defaults,...standardActivityDateDefaults,...filterCountDefaults}})};const registerActivityFilterWithValue=(id,group,label,{view:view=()=>{},edit:edit=()=>{},onMount:onMount=()=>{},defaults:defaults={}})=>{registerFilter(id,group,label,{view(filter){let{value,value_compare}=filter;let content=view(filter);if(value&&value_compare){content+=` worth ${activityFilterComparisons[value_compare].toLowerCase()} ${value}`}return standardActivityDateTitle(filterCountTitle(content,filter),filter)},edit(filter){let{value,value_compare}=filter;return[edit(filter),`
              ...
              </div>`,filterCount(filter),standardActivityDateOptions(filter)].join("")},onMount(filter,updateFilter){onMount(filter,updateFilter);$("#filter-value,#filter-value-compare").on("change",e=>{updateFilter({[e.target.name]:e.target.value})});filterCountOnMount(updateFilter);standardActivityDateFilterOnMount(filter,updateFilter)},defaults:{...defaults,...standardActivityDateDefaults,...filterCountDefaults,value:0,value_compare:"greater_than_or_equal_to"}})};registerActivityFilterWithValue("custom_activity","activity",__("Custom Activity","groundhogg"),{view:({activity})=>`<b>${activity}</b>`,edit:({activity,...filter})=>{return input({id:"filter-activity-type",name:"activity",value:activity,placeholder:"custom_activity"})},onMount(filter,updateFilter){$("#filter-activity-type").on("input",e=>{updateFilter({activity:e.target.value})})},defaults:{activity:""}});registerFilterGroup("query","Query");registerFilter("saved_search","query",__("Saved Search"),{view:({compare:compare="in",search})=>{return sprintf(__("Is %s search %s"),compare==="in"?"in":"not in",bold(SearchesStore.get(search)?.name))},edit:({compare})=>{return[select({name:"filter_compare",id:"filter-compare",options:{in:__("In"),not_in:__("Not in")},selected:compare}),select({name:"filter_search",id:"filter-search"})].join("")},onMount:({search},updateFilter)=>{SearchesStore.maybeFetchItems().then(items=>{$("#filter-search").select2({data:[{id:"",text:""},...items.map(({id,name})=>({id:id,text:name,selected:id===search}))],placeholder:__("Type to search...")}).on("change",e=>{updateFilter({search:e.target.value})})});$("#filter-compare").on("change",e=>{updateFilter({compare:e.target.value})})},defaults:{compare:"in",search:null},preload:({search})=>{if(!SearchesStore.hasItems()){return SearchesStore.fetchItems([])}}});ContactFilterRegistry.registerFilter(createFilter("sub_query","Sub Query","query",{display:({include_filters:include_filters=[],exclude_filters:exclude_filters=[]})=>{let texts=[ContactFilterRegistry.displayFilters(include_filters),ContactFilterRegistry.displayFilters(exclude_filters)].filter(s=>s);return texts.join(' <abbr title="exclude">and exclude</abbr> ')},edit:({include_filters:include_filters=[],exclude_filters:exclude_filters=[],updateFilter})=>{return Fragment([Div({className:"include-search-filters"},[Filters({id:"sub-query-filters",filters:include_filters,filterRegistry:ContactFilterRegistry,onChange:include_filters=>updateFilter({include_filters:include_filters})})]),Div({className:"exclude-search-filters"},[Filters({id:"sub-query-exclude-filters",filters:exclude_filters,filterRegistry:ContactFilterRegistry,onChange:exclude_filters=>updateFilter({exclude_filters:exclude_filters})})])])},preload:({include_filters:include_filters=[],exclude_filters:exclude_filters=[]})=>{return Promise.all([ContactFilterRegistry.preloadFilters(include_filters),ContactFilterRegistry.preloadFilters(exclude_filters)])}},{}));if(!Groundhogg.filters){Groundhogg.filters={}}Groundhogg.filters.functions={createFilters:createFilters,registerFilter:registerFilter,registerFilterGroup:registerFilterGroup,ComparisonsTitleGenerators:ComparisonsTitleGenerators,AllComparisons:AllComparisons,NumericComparisons:NumericComparisons,StringComparisons:StringComparisons,standardActivityDateOptions:standardActivityDateOptions,standardActivityDateTitle:standardActivityDateTitle,standardActivityDateDefaults:standardActivityDateDefaults,standardActivityDateFilterOnMount:standardActivityDateFilterOnMount,BasicTextFilter:BasicTextFilter,registerActivityFilter:registerActivityFilter,registerActivityFilterWithValue:registerActivityFilterWithValue}})(jQuery);