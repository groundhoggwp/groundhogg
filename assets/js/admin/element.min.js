...
${afterProgress()}`,onOpen:({setContent:setContent,close:close})=>{const{setProgress:setProgress}=progressBar("#progress-modal");onOpen({setContent:setContent,setProgress:setProgress,close:close})},...rest})};const loadingModal=(text="Loading",props={})=>{return modal({content:spinner(),canClose:false,dialogClasses:"gh-modal-loading",...props})};const spinner=()=>{return`
