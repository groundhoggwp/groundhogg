(function($){const{input:input,select:select,regexp:regexp,specialChars:specialChars,clickInsideElement:clickInsideElement,orList:orList,andList:andList,searchOptionsWidget:searchOptionsWidget,loadingDots:loadingDots}=Groundhogg.element;const{tagPicker:tagPicker,emailPicker:emailPicker,linkPicker:linkPicker}=Groundhogg.pickers;const{emails:EmailsStore,tags:TagsStore}=Groundhogg.stores;const Filters={view:function(){},edit:function(){},types:{},groups:{}};const renderFilterView=(filter,filterGroupIndex,filterIndex)=>{return`
		...
		<div class="filter filter-edit-wrap" data-key="${filterIndex}" data-group="${filterGroupIndex}">
		  ...
		  ${input({type:"date",value:date2,name:"date2",id:"filter-date2",className:`value ${date_range==="custom"?"":"hidden"}`})}`},onMount:function(filter,updateFilter){emailPicker("#filter-email",false,items=>{EmailsStore.itemsFetched(items)}).on("change",e=>{updateFilter({email_id:parseInt(e.target.value)})});$("#filter-date-range, #filter-date, #filter-date2").on("change",function(e){const $el=$(this);updateFilter({[$el.prop("name")]:$el.val()})})},defaults:{date_range:"24_hours",date:"",date2:"",email_id:0}},"Email Opened");registerFilter("page_visited","activity",{view:function({page_url:page_url,date_range:date_range,date:date,date2:date2}){switch(date_range){default:return`Visited <b>${page_url}</b> ${dateRanges[date_range].toLowerCase()}`;case"custom":return`Visited <b>${page_url}</b> between <b>${date}</b> and <b>${date2}</b>`}},edit:function({page_url:page_url,date_range:date_range,date:date,date2:date2}){return`${input({id:"filter-page-url",name:"page_url",value:page_url})} 
      
      ${select({id:"filter-date-range",name:"date_range"},dateRanges,date_range)} 
      
      ${input({type:"date",value:date,id:"filter-date",className:`date ${date_range==="custom"?"":"hidden"}`,name:"date"})}

      ${input({type:"date",value:date2,id:"filter-date2",className:`value ${date_range==="custom"?"":"hidden"}`,name:"date2"})}`},onMount:function(filter,updateFilter){linkPicker("#filter-page-url");standardActivityDateFilterOnMount(filter,updateFilter)},defaults:{date_range:"24_hours",date:"",date2:"",page_url:""}},"Page Visited");registerFilter("logged_in","activity",{view:function({date_range:date_range,date:date,date2:date2}){switch(date_range){default:return`<b>Logged in</b> ${dateRanges[date_range].toLowerCase()}`;case"custom":return`<b>Logged in</b> between <b>${date}</b> and <b>${date2}</b>`}},edit:function({date_range:date_range,date:date,date2:date2}){return`${select({id:"filter-date-range",name:"date_range"},dateRanges,date_range)} 
      
      ${input({type:"date",value:date,id:"filter-date",className:`date ${date_range==="custom"?"":"hidden"}`,name:"date"})}

      ${input({type:"date",value:date2,id:"filter-date2",className:`value ${date_range==="custom"?"":"hidden"}`,name:"date2"})}`},onMount:function(filter,updateFilter){standardActivityDateFilterOnMount(filter,updateFilter)},defaults:{date_range:"24_hours",date:"",date2:""}},"Logged In");registerFilter("not_logged_in","activity",{view:function({date_range:date_range,date:date,date2:date2}){switch(date_range){default:return`<b>Has not logged in</b> ${dateRanges[date_range].toLowerCase()}`;case"custom":return`<b>Has not logged in</b> between <b>${date}</b> and <b>${date2}</b>`}},edit:function({date_range:date_range,date:date,date2:date2}){return`${select({id:"filter-date-range",name:"date_range"},dateRanges,date_range)} 
      
      ${input({type:"date",value:date,id:"filter-date",className:`date ${date_range==="custom"?"":"hidden"}`,name:"date"})}

      ${input({type:"date",value:date2,id:"filter-date2",className:`value ${date_range==="custom"?"":"hidden"}`,name:"date2"})}`},onMount:function(filter,updateFilter){standardActivityDateFilterOnMount(filter,updateFilter)},defaults:{date_range:"24_hours",date:"",date2:""}},"Has Not Logged In");registerFilter("was_active","activity",{view:function({date_range:date_range,date:date,date2:date2}){switch(date_range){default:return`<b>Was active</b> ${dateRanges[date_range]}`;case"custom":return`<b>Was active</b> between <b>${date}</b> and <b>${date2}</b>`}},edit:function({date_range:date_range,date:date,date2:date2}){return`${select({id:"filter-date-range",name:"date_range"},dateRanges,date_range)} 
      
      ${input({type:"date",value:date,id:"filter-date",className:`date ${date_range==="custom"?"":"hidden"}`,name:"date"})}

      ${input({type:"date",value:date2,id:"filter-date2",className:`value ${date_range==="custom"?"":"hidden"}`,name:"date2"})}`},onMount:function(filter,updateFilter){standardActivityDateFilterOnMount(filter,updateFilter)},defaults:{date_range:"24_hours",date:"",date2:""}},"Was Active");registerFilter("was_not_active","activity",{view:function({date_range:date_range,date:date,date2:date2}){switch(date_range){default:return`<b>Was not active in</b> ${dateRanges[date_range]}`;case"custom":return`<b>Was not active in</b> between <b>${date}</b> and <b>${date2}</b>`}},edit:function({date_range:date_range,date:date,date2:date2}){return`${select({id:"filter-date-range",name:"date_range"},dateRanges,date_range)}

	  ${input({type:"date",value:date,id:"filter-date",className:`date ${date_range==="custom"?"":"hidden"}`,name:"date"})}

	  ${input({type:"date",value:date2,id:"filter-date2",className:`value ${date_range==="custom"?"":"hidden"}`,name:"date2"})}`},onMount:function(filter,updateFilter){standardActivityDateFilterOnMount(filter,updateFilter)},defaults:{date_range:"24_hours",date:"",date2:""}},"Was Not Active");registerFilter("completed_funnel_action","activity",{view:function({date_range:date_range,date:date,date2:date2}){switch(date_range){default:return`<b>Completed funnel action in</b> ${dateRanges[date_range]}`;case"custom":return`<b>Completed funnel action in</b> between <b>${date}</b> and <b>${date2}</b>`}},edit:function({date_range:date_range,date:date,date2:date2}){return`${select({id:"filter-date-range",name:"date_range"},dateRanges,date_range)} 
      
      ${input({type:"date",value:date,id:"filter-date",className:`date ${date_range==="custom"?"":"hidden"}`,name:"date"})}

      ${input({type:"date",value:date2,id:"filter-date2",className:`value ${date_range==="custom"?"":"hidden"}`,name:"date2"})}`},onMount:function(filter,updateFilter){standardActivityDateFilterOnMount(filter,updateFilter)},defaults:{date_range:"24_hours",date:"",date2:""}},"Completed Funnel Action")})(jQuery);