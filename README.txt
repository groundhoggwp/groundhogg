...
* HOT FIX Fixed archiving funnel cancelling all active events.

= 2.7.7.6 (2022-12-12) =
* HOT FIX Update method cancelling events...
...
* FIXED Insert at cursor replacements widget moving cursor to end of content in input fields.
...
* FIXED Potential for emails to be sent to undeliverable addresses.
...
* FIXED Unable to send email from contact record if no contact owner is selected

= 2.5.7.8 (2021-12-30) =
* FIXED "Send in local time" option missing for broadcasts.
* FIXED Time zone mapping not working during bulk edit or importing contacts.
...
* TWEAKED Hide the finish link during cron setup for White label installs.
